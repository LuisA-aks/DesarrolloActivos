...
namespace LoginLogoutMVC.Models
{
    public class DireccionesIP
    {
       ...
       // public string connString = "Data Source=DESKTOP-8CV6UC2;Initial Catalog=DT4333;Integrated Security=True";
        ...
        public string agregar_ip(string direccionIP, string conexionF)
        {
            string mensaje = "";
            ...
            using (SqlConnection myConn = new SqlConnection(conexionF))
            {
                ...
                mycmd.CommandText = "Execute SP_IngresarIP @ip";
                mycmd.Parameters.Add("@ip", SqlDbType.VarChar, 150).Value = direccionIP;              
