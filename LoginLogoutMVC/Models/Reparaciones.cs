...
namespace LoginLogoutMVC.Models
{
    ...
    {
        public string envioreparacion(string fecha, string observaciones, string boleta, int idfun, int idactivo, string conexionF)
        {
            string mensaje = "";
            ...
            using (SqlConnection myConn = new SqlConnection(conexionF))
            {
                try
                {
                    ...
                    mycmd.CommandText = "Execute SP_EnvioReparacion @idActivo,@idUsuario,@Observaciones,@fecha,@numboleta";
